...
class Quote(Resource):
    ...
    def post(self):
        ...
        query = f"INSERT INTO quotes (author, quote) VALUES ({data['author']}, {data['quote']}"
...
def main():
    connection = create_connection(os.path.join(base_dir, "db.sqlite"))
    create_quote_table = """
    ...
    """
    execute_query(connection, create_quote_table)
